		...
		<Global
			 ...
			 */
				...
				abbr {
					...
					font-feature-settings: 'kern' 1, 'liga' 1, 'calt' 1, 'pnum' 1,
						'tnum' 0, 'onum' 1, 'lnum' 0, 'smcp' 1, 'c2sc' 1; /* 2 */
				}
			 ...
			 */
				...
				samp,
				code {
					font-feature-settings: 'kern' 0, 'liga' 0, 'calt' 1, 'dlig' 0,
						'pnum' 0, 'tnum' 1, 'onum' 0, 'lnum' 1, 'zero' 1; /* 1. */
				}
			 ...
			 */
				...
				sup {
					font-feature-settings: 'kern' 1, 'liga' 1, 'calt' 1, 'pnum' 1,
						'tnum' 0, 'onum' 1, 'lnum' 0, 'dlig' 0, 'sups' 1; /* 1. */
				}
			 ...
			 */
				...
				sub {
					font-feature-settings: 'kern' 1, 'liga' 1, 'calt' 1, 'pnum' 1,
						'tnum' 0, 'onum' 1, 'lnum' 0, 'dlig' 0, 'subs' 1; /* 1. */
				}
			 ...
			 */
				...
				input[type='tel'],
				input[type='week'] {
					font-feature-settings: 'kern' 0, 'liga' 1, 'calt' 1, 'pnum' 1,
						'tnum' 0, 'onum' 0, 'lnum' 1, 'zero' 0; /* 1. */
				}
			 ...
			 */
				...
				tbody,
				caption {
					font-feature-settings: 'kern' 1, 'liga' 1, 'calt' 1, 'pnum' 0,
						'tnum' 1, 'onum' 0, 'lnum' 1, 'zero' 1; /* 1. */
				}
			`}
		/>
	)
